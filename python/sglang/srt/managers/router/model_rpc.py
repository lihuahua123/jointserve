...
class ModelRpcServer:
    def __init__(
        ...
        # lora_paths = ["tloen/alpaca-lora-7b"]
        self.model_runner = ModelRunner(
            ...
            lora_paths=server_args.lora_paths,
        )
        ...
        if server_args.lora_paths is not None:
            self.lora_req_idxs = [-1 for _ in server_args.lora_paths]
    ...
    def handle_generate_request(
        ...
        # if req.lora_uid is not None:
        #     lora_req_idx = self.lora_req_idxs[req.lora_uid]
        #     if lora_req_idx != -1 and lora_req_idx != len(self.forward_queue)-1:
        #         now_lora_req_idx = now_lora_req_idx + 1
        #         self.forward_queue.insert(now_lora_req_idx, req)
        #         self.lora_req_idxs[req.lora_uid] = now_lora_req_idx
        #     else:
        #         now_lora_req_idx = len(self.forward_queue)-1
        #         self.lora_req_idxs[req.lora_uid] = now_lora_req_idx
